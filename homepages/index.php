<?php
	function css_resize($desired_h,$image_url)
	{
		...
		return "style=\"height:{$final_height}px; width:{$final_width}px;\"";
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container-fluid">
	<div class="row">
		...
		<div id="container" class="container mx-auto col-lg-8 col-sm-12">
			  	...
			  	<div class="carousel-inner">
			    	<?php 
						...
						foreach (glob($image_path) as $image) {
							...
							$style = css_resize(500,$image);

							echo("
							<div class=\"carousel-item w-100 {$active}\" style=\"height:500px;\">
					  			<img src=\"{$image}\" class=\"d-block mx-auto\" alt=\"...\" {$style}> 
